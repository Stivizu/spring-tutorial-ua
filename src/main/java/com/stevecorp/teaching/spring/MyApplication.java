...
import com.stevecorp.teaching.spring.service.AddressService;
...
import static com.stevecorp.teaching.spring.util.StudentGenerator.generateStudentRoomAddress;
...
public class MyApplication {
    ...
    public static void main(final String... args) {
        ...
        final Student studentToReinsert = students.get(0);
        ...
        /*
            Surprisingly, Spring did not add a new student, but it updates the existing student.
             This is because both of the insert and update are dong via the repository.save method.
        ...
        final Long studentIdToDelete = students.get(students.size() - 1).getId();
         ...
         */
        final int birthYear = students.get(0).getDateOfBirth().getYear();
        final String cityZip = students.get(0).getAddresses().get(0).getZip();
